 ...
 *
 * Through authFetch like everything else here, so there is one auth header and
 * one 401 path. Paths passed to epms* include /api/v1 — this base, unlike the
 * others in this file, does not add it.
 */
