...
def upgrade() -> None:
    ...
    sa.Column('capa_remind_before_days', sa.Integer(), nullable=False),
    sa.Column('capa_escalate_supervisor_days', sa.Integer(), nullable=False),
    sa.Column('capa_escalate_manager_days', sa.Integer(), nullable=False),
    sa.Column('cert_warn_days', postgresql.JSONB(astext_type=sa.Text()), server_default='[90, 60, 30]', nullable=False),
    sa.Column('allow_anonymous_report', sa.Boolean(), nullable=False),
    sa.Column('statutory_scan_interval_minutes', sa.Integer(), nullable=False),
    ...
    sa.Column('mol_reportable', sa.Boolean(), nullable=False),
    ...
    sa.Column('is_safety_sensitive', sa.Boolean(), nullable=False),
    ...
    sa.Column('sent_offsite', sa.Boolean(), nullable=False),
    ...
    sa.Column('action_type', sa.String(length=15), nullable=False),
    sa.Column('title', sa.String(length=255), nullable=False),
    sa.Column('description', sa.Text(), nullable=True),
