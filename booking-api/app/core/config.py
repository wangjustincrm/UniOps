"""booking-api settings (loaded from env, .env, or docker-compose)."""
...
class Settings(BaseSettings):
    ...
    # Local timezone for iCal TZID and human-facing displays. Times are
    # stored in UTC; exports render them in this zone. IANA name.
    ...
    # ── Background scheduler (notification retry / reminder jobs) ────────────
    # In-process asyncio loop started in the FastAPI lifespan. A Postgres
    ...
    SCHEDULER_INTERVAL_SECONDS: int = 300  # 5 min retry cadence
