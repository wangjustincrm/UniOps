...
get_session / get_current_user_payload dependencies wired in; it deliberately
does not expose a module-level require_permission because those dependency
names differ across services.
"""
