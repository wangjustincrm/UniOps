...
import type { BookingSlimOut, SuggestOut, RoomWithStatusOut, RoomStatusNow } from '@/lib/types'
...
const STATUS_STYLE: Record<RoomStatusNow, string> = {
...
const STATUS_LABEL: Record<RoomStatusNow, string> = {
  free:          'Available',
  in_use:        'In Use',
              ...
              return (
                ...
                >
                  ...
                  <span className={cn(
                    ...
                    STATUS_STYLE[room.status_now],
                  )}>
                    {STATUS_LABEL[room.status_now]}
                  </span>
                </button>
              )
            })}
