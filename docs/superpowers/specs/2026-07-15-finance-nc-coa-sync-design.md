...
### 14.8 遗留待查:6601 直接分录异常(本分支不修,单列)

我们镜像里 `account_code='6601'`(非末级)挂着 **2454 行直接分录**(累计借 8.4M、期初 +349,824.95),而 NC 的 6601 无任何直接分录(纯汇总:其累计 3,731,938.53 = 660101 + 660102 分毫不差)。这不影响 6 月**发生额**(6601 本期直接=0),但会让期初/期末对不平 NC。疑与科目映射或跨账套有关,**另开任务排查**,不阻断本次 rollup + §14.7 发布。
