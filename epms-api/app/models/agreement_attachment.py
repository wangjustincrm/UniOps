"""ORM model for Agreement attachments."""
import uuid
...
class AgreementAttachment(UUIDPrimaryKey, TimestampMixin, Base):
    __tablename__ = "agreement_attachments"

    agreement_id: Mapped[uuid.UUID] = mapped_column(
        UUID(as_uuid=True), ForeignKey("purchase_agreements.id", ondelete="CASCADE"), nullable=False, index=True
    )
