...
from app.models import admin_audit_log, ap_invoice, bank, coa, fiscal_period, mirrors, nc_sync, pa, payment, payment_batch, posting  # noqa: F401 — register with metadata
