...
Maps to the shared admin_audit_log table already created by epms-api migration.
...
class AdminAuditLog(UUIDPrimaryKey, Base):
    ...
    system: Mapped[str] = mapped_column(String(20), nullable=False)        # epms | oa | vms | finance
